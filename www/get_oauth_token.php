...
require '/var/www/sscait-web/vendor/autoload.php';
...
if (!isset($_GET['code'])) {
    ...
    echo 'Refresh Token Has Expired: ', ($token->hasExpired() == true) ? 'true' : 'false';
    if ($token->getExpires() !== null) {
        echo ', Refresh Token Expires In (Seconds): ', $token->getExpires();
    }
