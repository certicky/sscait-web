...
<h4>Tournaments:</h4>
    ...
    <ul>
        <li>
            ...
            In order to participate in the yearly tournament, every bot <b>must have its own page</b> on Liquipedia. The Liquipedia page should either have the bot's name in URL, or should be linked from the <a href="https://liquipedia.net/starcraft/Category:Bots" target="_blank">Bots category</a> list. That page must contain the <b>names of all the programmers</b> who made the bot. If the bot is <b>based on some other bot</b>, this also needs to be disclosed on the page. Please use the <a href="https://liquipedia.net/starcraft/Template:Infobox_bot" target="_blank">Infobox_bot template</a> when creating that page.
        </li>
        <li>
